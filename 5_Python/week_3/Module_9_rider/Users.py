...
# ride sharing akta cls jeta te company name dita hy, r drivers, riders, ride ar array ace and ader element addk korber jonn function ace

sakib = Rider("sakib Khan", 'sakib@khan.com', 1254, 'mohakhali', 1200)
# user k inharit kroacha, name-email-nid user handel korcha,
# current location and inital amount nijar kace rakhca.current location k update location diea update kora jabe. initial amount a chile aro tk add kora jabe load cash function ar maddom a

# rider request_ride korta parbe : ar jonno ride_sharing(jar moddha drivers,riders,ride array ace) r destination dita hobe,

#ride_request k self(rider arname, email, nid, current_location, initial_amount) diea dawa r destination dawa,
